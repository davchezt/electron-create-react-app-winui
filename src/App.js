...
import { Window, TitleBar, Text, NavPane, NavPaneItem, View } from 'react-desktop/windows';
import {
  IoIosHome,
  IoIosHeart,
  IoIosSettings,
    ...
    return (
      ...
      >
        <TitleBar
          ...
          theme={this.props.theme}
          background="#171717" //{this.props.color}
        ...
        <NavPane openLength={200} push color={this.props.color} theme={this.props.theme}>
          {this.renderItem('Dahboard', <Dashboard {...this.props} />)}
          {this.renderItem('Loved', 'Loved Content')}
          {this.renderItem('Settings', <Settings {...this.props} theme={this.props.inputTheme} />)}
        </NavPane>
      </Window>
    );
  }
